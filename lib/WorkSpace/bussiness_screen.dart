...
class BussnessNews extends StatelessWidget {
  const BussnessNews({super.key});
    ...
    return BlocConsumer<GoosenewsCubit, GoosenewsState>(
      ...
      builder: (context, state) {
        ...
        return BuildCondition(
          ...
          condition: goosecubit.bussinessModel != null,
          //then
          builder: (context) {
            ...
            return ListView.separated(
                ...
                itemBuilder: (context, index) =>
                    buildnews(goosecubit.bussinessModel!, index, context),
                separatorBuilder: (BuildContext context, int index) {
                  return const SizedBox(
                    height: 1,
                  );
                },
                itemCount: goosecubit.bussinessModel!.articles.length);
          },
          //else
